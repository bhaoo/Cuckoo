        ...
        <div class="mdui-card-media-covered">
          <div class="mdui-card-primary">
            <?php if ($this->fields->articleType == "daily") { ?>
              <div class="mdui-card-primary-title"><?php $this->date(); ?></div>
              <div class="mdui-card-primary-subtitle article-subtitle"><?php get_post_view($this) ?> 浏览 | 分类：<?php $this->category(','); ?> | 标签：<?php $this->tags(','); ?></div>
